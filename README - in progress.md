...
A program that applies image processing filters to BMP files by directly manipulating raw pixel data.
...
A program that simulates a ranked-choice election using the instant-runoff voting method.
